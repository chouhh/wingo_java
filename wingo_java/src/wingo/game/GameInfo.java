...
import static wingo.go.Score.ScoringMethod.AREA;
import static wingo.go.Score.ScoringMethod.TERRITORY;

import java.util.Locale;
import java.util.Map;
import java.util.TreeMap;

import wingo.go.BlackWhiteSet;
import wingo.go.GoColor;
import wingo.go.Komi;
import wingo.go.Score.ScoringMethod;
import wingo.util.ObjectUtil;
